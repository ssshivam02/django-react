            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        unique=True,
                        verbose_name="Property Refrerence Code",
                    ),
                ),
                (
                    "description",
                ...
                (
                    "city",
                    models.CharField(
                        blank=True, default="Pune", max_length=255, verbose_name="City"
                    ),
                ),
                (
                    "postal_code",
                    models.CharField(
                        default="800026", max_length=100, verbose_name="Postal Code"
                    ),
                ),
                (
                    "street_address",
                    models.CharField(
                        default="Bhootnath Road",
                        max_length=550,
