...
class Property(TimeStampedUUIDModel):
    ...
    ref_code= models.CharField(verbose_name=_("Property Refrerence Code"), max_length=255, unique=True, blank=True)
    description = models.TextField(verbose_name=_("Description"), default="Default description...update me please....")
    country = CountryField(verbose_name=_("Country"), blank_label="Select Country", default="IN")
    city = models.CharField(verbose_name=_("City"), max_length=255, blank=True, default="Pune")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=100,default="800026")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=550, default="Bhootnath Road")
    property_number = models.IntegerField(verbose_name=_("Property Number"), validators=[MinValueValidator(1)],default=11)
    ...
    advert_type = models.CharField(_("Advert Type"), max_length=50, choices=AdveertType.choices, default=AdveertType.FOR_SALE)
    property_type = models.CharField(_("Property Type"), max_length=50, choices=PropertyType.choices, default=PropertyType.OTHER)
    cover_photo = models.ImageField(verbose_name=_("Main Photo"), default = "/house_sample.jpg", upload_to="properties", null=True,blank=True)
